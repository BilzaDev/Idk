...
elseif game.PlaceId == 1537690962 then
	...
	local function ClaimHive()
		...
		for i, v in pairs(hives) do
			vlol = game.Workspace.Honeycombs:GetChildren()[i] 
			if vlol.Owner.Value == nil then 
				game.ReplicatedStorage.Events.ClaimHive:FireServer(vlol.HiveID.Value)
			end
		end  
	end
	...
	Section1:NewButton("Claim Hive", "Claim Hive", function()
		ClaimHive()
	end)
